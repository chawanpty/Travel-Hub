...
<body>
  ...
  <div class="container">
    <div class="row">
      <div class="col-md-12">
        <h1 class="mt-5" id="h1ok"><b>Profile Page</b></h1>
        <div class="mt-5">
          <div class="card-body box1 font" style="line-height: 2.5;">
            <h3><b>รายละเอียดบัญชี</b></h3>

            <!-- ทำการแสดงผลข้อมูลที่ query ขึ้นมา  โดยรูปแบบจะเป็น $row['ชื่อคอลัมน์']-->
            <span class="mt-5" style="font-weight: 700;">Username</span> : &nbsp;<span>
              <?php echo $row['user_username']; ?>
            </span><br>
            <span style="font-weight: 700;">Firstname</span> : &nbsp;<span>
              <?php echo $row['user_firstname']; ?>
            </span><br>
            <span style="font-weight: 700;">Lastname</span> : &nbsp;<span>
              <?php echo $row['user_lastname']; ?>
            </span><br>
            <span style="font-weight: 700;">Email</span> : &nbsp;<span>
              <?php echo $row['user_email']; ?>
            </span><br>
            <span style="font-weight: 700;">Phone</span> : &nbsp;<span>
              <?php echo $row['user_phone']; ?>
            </span><br>
            <span style="font-weight: 700;">Edit</span> : &nbsp;<span><a href="updateprofile.php"
                class="btn btn-primary"><i class="bi bi-pencil-square"></i></a></span><br>
          </div>
        </div>
      </div>
    </div>
